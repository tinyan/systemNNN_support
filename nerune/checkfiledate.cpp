...
BOOL CCheckFileDate::CheckNeedUpdate(LPSTR src,LPSTR dst)
{
	FILETIME srctime;
	FILETIME dsttime;

	HANDLE hDst = CreateFile(dst,GENERIC_READ,FILE_SHARE_READ,NULL,OPEN_EXISTING,FILE_ATTRIBUTE_NORMAL,NULL);
